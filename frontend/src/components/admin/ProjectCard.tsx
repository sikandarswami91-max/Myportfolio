...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <motion.tr
      ...
      className="border-b border-neutral-800/80 hover:bg-neutral-800/30 transition-colors group"
    >
      {/* Project Cover & Title */}
      <td className="py-4 px-4 sm:px-6">
        <div className="flex items-center gap-3.5">
          <div className="w-14 h-10 rounded-lg bg-neutral-950 border border-neutral-800 overflow-hidden shrink-0 relative">
            {project.image ? (
              <img
                src={project.image}
                alt={project.title}
          ...
          <div className="min-w-0 max-w-xs sm:max-w-sm">
            <div className="flex items-center gap-2">
              <span className="font-semibold text-white text-sm truncate font-heading group-hover:text-cyan-400 transition-colors">
                {project.title}
              </span>
            </div>
      ...
      {/* Created Date */}
      <td className="py-4 px-4 hidden sm:table-cell text-xs text-neutral-400 font-mono">
