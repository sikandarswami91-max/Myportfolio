    ...
    <section id="about" className="py-24 sm:py-32 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="prose dark:prose-invert max-w-none text-neutral-600 dark:text-neutral-300 text-base leading-relaxed space-y-4">
              <p>
                Hello! I’m <span className="font-semibold text-neutral-900 dark:text-white">Sikandar</span>, a dedicated{' '}
                <span className="text-cyan-600 dark:text-cyan-400 font-semibold">MERN Stack Developer</span> currently pursuing my{' '}
                <span className="font-semibold text-neutral-900 dark:text-white">Bachelor of Computer Applications (BCA)</span>, Semester VI (Session 2025–26).
              </p>

              <p>
                My passion lies in architecting full-stack web solutions where design elegance meets scalable backend engineering. With hands-on expertise spanning <span className="font-semibold text-neutral-900 dark:text-white">React.js, Node.js, Express.js, and MongoDB</span>, I enjoy building everything from interactive AI-driven assistants to robust enterprise portals and consumer e-commerce storefronts.
              </p>

              <p>
                During my <span className="font-semibold text-neutral-900 dark:text-white">6-month tenure at V MART</span>, I gained valuable frontline exposure to digital retail operations and inventory workflows, strengthening my discipline for writing clean code, preventing edge-case bugs, and delivering reliable software under real-world requirements.
              </p>
            </div>
              ...
              return (
                <motion.div
                  ...
                  className={`p-5 rounded-2xl border transition-all duration-300 relative group overflow-hidden ${
                    isDark
                      ? 'bg-neutral-900/70 border-neutral-800 hover:border-neutral-700 hover:shadow-[0_12px_30px_rgba(0,0,0,0.5)]'
                ...
                >
                  ...
                  <h3 className="text-base font-bold font-heading text-neutral-900 dark:text-white mb-2">
                    {card.title}
                  </h3>
